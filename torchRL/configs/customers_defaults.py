...
_C.NET.NUM_LAYERS = 1
_C.NET.HIDDEN_DIM = 1000
_C.NET.ACTION_DIM = 30
_C.NET.STATE_DIM = 1000

_C.ENV = CN()
_C.ENV.NAME = "CustomersVisit-v1"
_C.ENV.TYPE = "ClassicControl"
_C.ENV.MAX_EPISODE_STEPS = 100
_C.ENV.NUM_CONTENTS = 30
_C.ENV.NUM_CUSTOMERS = 1000
_C.ENV.NUM_OUTPUT = 4
_C.ENV.NUM_PREFERENCE = 2
_C.ENV.PROBABILITY = 1.0
_C.ENV.REWARD_SCALE = 1.0
_C.ENV.SEED = 10

_C.TRAIN = CN()
_C.TRAIN.TRAINER = ""
_C.TRAIN.NUM_EPISODES = 20000
